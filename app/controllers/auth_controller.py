...
class AuthController:
    ...
    def register(self, username, password, role, first_name, last_name, additional_info=None):
        ...
        if role == "student":
            self.student_model.create_student(user_id, first_name, last_name, additional_info)
        elif role == "teacher":
            self.teacher_model.create_teacher(user_id, first_name, last_name, additional_info)
