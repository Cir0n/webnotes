...
class TeacherViews:
    ...
    def register_route(self):
        ...
        @self.teacher_bp.route("/class/<int:class_id>", methods=["GET", "POST"])
        def class_students(class_id):
            ...
            subjects = self.teacher_controller.get_subject_by_teacher(teacher_id)
            ...
            if form.validate_on_submit():
                ...
                self.teacher_controller.add_grade(teacher_id, student_id, subject_id, grade, comment)
        ...
        @self.teacher_bp.route("/delete_grade/<int:student_id>", methods=["POST"])
