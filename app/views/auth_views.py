    ...
    def register_routes(self):
        ...
        def register():
            if request.method == 'POST':
                ...
                result = self.controller.register(username, password, role, first_name, last_name, additional_info)

                if "error" in result:
                    return render_template("auth/register.html", message=result["error"])
